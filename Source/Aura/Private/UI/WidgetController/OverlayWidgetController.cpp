...
void UOverlayWidgetController::BindCallbacksToDependencies()
{
	...
	if (GetAuraASC())
	{
		GetAuraASC()->AbilityAssigned.AddUObject(this, &UOverlayWidgetController::OnAbilityAssigned);
...
void UOverlayWidgetController::OnAbilityAssigned(const FGameplayTag& AbilityTag, const FGameplayTag& Status,
